...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    %type <expressions> expression_list  // , delimit
    %type <expressions> nonempty_expression_list
    %type <expressions> expression_block  // ; delimit
    ...
    */
    ...
    class	: 
      ...
      stringtable.add_string(curr_filename)); } // this is used for the constructor in aps file for AST
    ...
    let_expr:
      ...
      | OBJECTID ':' TYPEID ',' let_expr  // the semantic value of let_expr is that of the body, which is the last expression
      { $$ = let($1, $3, no_expr(), $5); }
